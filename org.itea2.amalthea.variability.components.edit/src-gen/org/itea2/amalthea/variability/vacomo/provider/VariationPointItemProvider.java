...
/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.vacomo.VariationPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariationPointItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VacomoPackage.Literals.VARIATION_POINT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationPoint_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationPoint_description_feature", "_UI_VariationPoint_type"),
				 VacomoPackage.Literals.VARIATION_POINT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VacomoPackage.Literals.VARIATION_POINT__VARIANTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariationPoint.class)) {
			case VacomoPackage.VARIATION_POINT__NAME:
			case VacomoPackage.VARIATION_POINT__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case VacomoPackage.VARIATION_POINT__VARIANTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VacomoPackage.Literals.VARIATION_POINT__VARIANTS,
				 VacomoFactory.eINSTANCE.createVariant()));
	}
