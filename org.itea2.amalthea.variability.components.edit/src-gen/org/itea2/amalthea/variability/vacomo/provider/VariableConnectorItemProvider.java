...
public class VariableConnectorItemProvider extends ConnectorItemProvider {
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableConnector_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableConnector_target_feature", "_UI_VariableConnector_type"),
				 VacomoPackage.Literals.VARIABLE_CONNECTOR__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_VariableConnector_type");
	}
