...
import org.itea2.amalthea.variability.ample.Actuator;
import org.itea2.amalthea.variability.ample.AmplePackage;

/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.ample.Actuator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActuatorItemProvider extends PeripheralItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmplePackage.Literals.ACTUATOR__QUANTITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		if (actuator.getIdentifier() != null && !actuator.getIdentifier().isEmpty()) {
			stb.append(actuator.getIdentifier());
		} else {
			stb.append("<Actuator>");
		}
		if (actuator.getQuantity() > 1) {
			stb.append(" (qty.:" + actuator.getQuantity() + ")");
		}
		return stb.toString();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actuator.class)) {
			case AmplePackage.ACTUATOR__QUANTITY:
