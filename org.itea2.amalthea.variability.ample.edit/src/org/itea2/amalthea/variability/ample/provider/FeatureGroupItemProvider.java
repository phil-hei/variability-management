...
/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.ample.FeatureGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureGroup_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_name_feature", "_UI_FeatureGroup_type"),
				 AmplePackage.Literals.FEATURE_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeatureGroup.class)) {
			case AmplePackage.FEATURE_GROUP__NAME:
