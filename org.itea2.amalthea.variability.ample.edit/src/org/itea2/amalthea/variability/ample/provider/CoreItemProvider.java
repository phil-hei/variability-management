...
public class CoreItemProvider extends HardwareElementItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Core.png"));
	}
	...
	public String getText(Object object) {
		...
		if (core.getIdentifier() != null && !core.getIdentifier().isEmpty()) {
			stb.append(core.getIdentifier());
		} else {
			stb.append("<Core>");
		}

		if (core.getQuantity() > 1) {
			stb.append(" (qty.: " + core.getQuantity() + ")");
		}
		return stb.toString();
	}
