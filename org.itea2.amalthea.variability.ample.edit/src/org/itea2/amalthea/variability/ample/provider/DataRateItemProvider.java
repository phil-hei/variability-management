...
import org.itea2.amalthea.variability.ample.DataRateUnit;
...
public class DataRateItemProvider extends UnitItemProvider {
	...
	public String getText(Object object) {
		...
		stb.append(dataRate.getValue());
		if (dataRate.getDataRateUnit() != DataRateUnit._UNDEFINED_) {
			stb.append(" " + dataRate.getDataRateUnit().toString());
		} else {
			stb.append(" <unit>");
		}
