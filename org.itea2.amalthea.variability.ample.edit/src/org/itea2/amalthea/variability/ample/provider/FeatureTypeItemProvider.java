...
import org.itea2.amalthea.variability.ample.FeatureType;

/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.ample.FeatureType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureType_name_feature", "_UI_FeatureType_type"),
				 AmplePackage.Literals.FEATURE_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeatureType.class)) {
			case AmplePackage.FEATURE_TYPE__NAME:
