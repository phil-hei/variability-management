...
import org.itea2.amalthea.variability.ample.Dependency;

/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.ample.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmplePackage.Literals.DEPENDENCY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_description_feature", "_UI_Dependency_type"),
				 AmplePackage.Literals.DEPENDENCY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		if (dependency.getName() != null && !dependency.getName().isEmpty()) {
			stb.append(dependency.getName());
		} else {
			stb.append("<Dependency>");
		}
		return stb.toString();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dependency.class)) {
			case AmplePackage.DEPENDENCY__NAME:
			case AmplePackage.DEPENDENCY__DESCRIPTION:
