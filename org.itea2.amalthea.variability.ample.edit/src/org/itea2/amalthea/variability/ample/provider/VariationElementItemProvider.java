 ...
 * {@link org.itea2.amalthea.variability.ample.VariationElement} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class VariationElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	/**
	 * This returns VariationElement.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public String getText(Object object) {
		VariationElement ve = (VariationElement) object;
		StringBuilder stb = new StringBuilder();

		if (ve.getName() != null && !ve.getName().isEmpty()) {
			stb.append(ve.getName());
		} else {
			stb.append("<Variation Element>");
		}
