...
import org.itea2.amalthea.variability.ample.Cache;

/**
 * This is the item provider adapter for a {@link org.itea2.amalthea.variability.ample.Cache} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CacheItemProvider extends MemoryItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmplePackage.Literals.CACHE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cache_level_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cache_level_feature", "_UI_Cache_type"),
				 AmplePackage.Literals.CACHE__LEVEL,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmplePackage.Literals.CACHE__FREQUENCY);
		}
	...
	public String getText(Object object) {
		String label = ((Cache)object).getIdentifier();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Cache.class)) {
			case AmplePackage.CACHE__TYPE:
			case AmplePackage.CACHE__LEVEL:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case AmplePackage.CACHE__FREQUENCY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmplePackage.Literals.CACHE__FREQUENCY,
